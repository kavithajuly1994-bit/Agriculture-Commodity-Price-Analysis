...
# 📊 Project Overview
* Comparative Price Analysis – To compare modal, minimum, and maximum
prices across commodities, markets, and states on a specific date.
 * Market Insights – To identify top-performing markets based on price levels.
 * Commodity Price Profiling – To determine which commodities command
higher wholesale prices and which are lower. Regional Price Variability – To visualize and understand how commodity
